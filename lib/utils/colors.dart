...
class KColors {
  static const kPrimary = Color(0xffE8CD62);
  static const kSecondary = Color(0xff0746AD);
  static const kTcolor = Color(0xff2C2C2C);
  // static const kBordercolor = Color(0xff);
